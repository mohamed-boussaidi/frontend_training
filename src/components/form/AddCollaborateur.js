...
const AddCollaborateur = (props) => {
    ...
    const [selectedMultiCivilite, setSelectedMultiCivilite] = useState(props.data ? {
        label: props.data.sexe,
        value: props.data.sexe
    } : null)
    ...
    const [selectedMultiContatType, setselectedMultiContatType] = useState(props.data ? {
        label: props.data.type_contrat,
        value: props.data.type_contrat
    } : null)
    ...
    const [selectedMultifonction, setselectedMultifonction] = useState(props.data ? {
        label: props.data.fonction,
        value: props.data.fonction
    } : null)
    ...
    function handleValidation() {
        ...
        if (!selectedMultiCivilite) {
            formIsValid = false;
            errors["selectedMultiCivilite"] = "SVP Entrez votre Civilité";
        }
        if (!selectedMultiContatType) {
            formIsValid = false;
            errors["selectedMultiContatType"] = "SVP Entrez votre type de contact";
        }
        if (!selectedMultifonction) {
            formIsValid = false;
            errors["selectedMultifonction"] = "SVP Entrez votre fonction";
        }
            ...
            <Row>
                ...
                <Col md="6">
                    <div className="mb-3 templating-select select2-container">
                        ...
                        />
                        <span className="text-danger">{errors['selectedMultiCivilite']}</span>
                ...
                <Col md="6">
                    <div className="mb-3">
                        ...
                        <AvField
                            ...
                            errorMessage=" SVP Entrez votre Carte d'identité"
                            validate={{required: {value: true}}}
                    ...
                    <div className="mb-3">
                        ...
                        <div className="col-md-13">
                            <AvField
                                ...
                                errorMessage=" SVP Entrez votre Date de Naissance."
                                validate={{required: {value: true}}}
                            />
                        </div>
                    </div>
                ...
                <Col md="6">
                    <div className="mb-3 templating-select select2-container">
                        ...
                        <Select
                            ...
                            closeMenuOnSelect={false}
                        />
                        <span className="text-danger">{errors['selectedMultiContatType']}</span>
                ...
                <Col md="6">
                    <div className="mb-3 templating-select select2-container">
                        ...
                        <Select
                            ...
                            closeMenuOnSelect={false}
                        />
                        <span className="text-danger">{errors['selectedMultifonction']}</span>
                    ...
                    <div className="mb-3">
                        ...
                        <div className="col-md-13">
                            <AvField
                                ...
                                validate={{required: {value: true}}}
                                errorMessage=" SVP Entrez votre Date d'entree"
                    ...
                    <div className="mb-3">
                        ...
                        <div className="col-md-13">
                            <AvField
                                ...
                                validate={{required: {value: true}}}
                                errorMessage=" SVP Entrez votre Date de Sortie"
