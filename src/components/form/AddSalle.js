...
import {array_to_select_options_list, dataURLtoFile, join_String_save} from "../../utlis/functions";
...
const AddSalle = (props) => {
    ...
    function handleValidation() {
        ...
        if (!selectedMultiEquipements) {
            formIsValid = false;
            errors["selectedMultiEquipements"] = "SVP Entrez les equipements";
        }
            ...
            <Row>
                <Col md="6">
                    <div className="mb-3 templating-select select2-container">
                        ...
                        />
                        <span className="text-danger">{errors['selectedMultiEquipements']}</span>
